...
from gestprojet.projects import views
...
urlpatterns = [
    ...
    path('admin/<int:pk>/', views.AdminProjectDetailView.as_view(), name='admin_project_detail'),
    ...
    path('admin/<int:project_pk>/activity/create/', views.AdminActivityCreateView.as_view(), name='admin_activity_create'),
    path('admin/activity/<int:pk>/update/', views.AdminActivityUpdateView.as_view(), name='admin_activity_update'),
    path('admin/activity/<int:pk>/delete/', views.AdminActivityDeleteView.as_view(), name='admin_activity_delete'),

    path('admin/activity/<int:activity_pk>/subactivity/create/', views.AdminSubActivityCreateView.as_view(), name='admin_subactivity_create'),
