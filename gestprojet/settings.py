"""
Django settings for gestprojet project.
...
SECRET_KEY = 'django-insecure-o%+=%s*7f9q#dbpt5jj-&^-rw37tchf^6vb7rw96spka30d51c'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'gestprojet.context_processors.sidebar_counts',
            ],
        },
    },
]
