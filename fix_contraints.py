...
with connection.cursor() as cursor:
    ...
    """)
    print("📋 Contraintes UNIQUE sur projects_activity:", [row[0] for row in cursor.fetchall()])
    ...
    cursor.execute("""
        ...
        AND constraint_type = 'UNIQUE';
    """)
    print("📋 Contraintes UNIQUE sur projects_subactivity:", [row[0] for row in cursor.fetchall()])
